    ...
    <Container className="mt-16 lg:mt-24">
      ...
      <div className="bg-linear-to-br from-white via-shop_light_bg to-shop_light_pink p-8 lg:p-12 rounded-3xl shadow-xl border border-shop_light_blue/20">
            ...
            >
              ...
              <div className="flex justify-center mb-5">
                {category?.image && (
                  <div className="relative w-20 h-20 rounded-2xl overflow-hidden bg-linear-to-br from-shop_light_pink to-shop_light_bg p-3 group-hover:shadow-lg hoverEffect">
                    ...
                    />
                    <div className="absolute inset-0 bg-linear-to-t from-shop_light_blue/10 to-transparent opacity-0 group-hover:opacity-100 hoverEffect rounded-xl"></div>
                  </div>
                )}
              </div>
              ...
              <div className="text-center space-y-3">
                ...
                <div className="w-full bg-gray-100 rounded-full h-2 mt-3">
                  <div
                    className="bg-linear-to-r from-shop_light_blue to-shop_dark_blue h-2 rounded-full hoverEffect"
                    style={{ width: `${Math.random() * 60 + 40}%` }}
                  ></div>
                </div>

                {/* Shop Now Button */}
                <div className="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-linear-to-r from-shop_light_pink to-shop_light_bg text-shop_dark_blue font-medium rounded-full group-hover:from-shop_light_blue group-hover:to-shop_dark_blue group-hover:text-white text-sm hoverEffect">
                  Shop Now
                  <svg
        ...
        <div className="text-center mt-8">
          <div className="inline-flex items-center gap-4 px-8 py-4 bg-linear-to-r from-shop_light_pink to-shop_light_bg rounded-2xl border border-shop_light_blue/20">
